...
function ProductDetail() {
  ...
  return productData ? (
    <div>
      <div className="w-[100%] min-h-screen bg-gradient-to-l from-[#141414] to-[#0c2025] flex flex-col lg:flex-row items-center justify-center py-16 lg:py-20 gap-10">
        {/* ✅ Left Section - Image Gallery */}
        <div className="flex flex-col lg:flex-row-reverse items-center justify-center gap-8 w-[90%] lg:w-[60%]">
          {/* Main Image */}
          <div className="w-[80%] lg:w-[70%] h-[60vh] lg:h-[80vh] border border-gray-500 rounded-md overflow-hidden shadow-lg flex items-center justify-center ">
            <img
              src={image}
              alt=""
          ...
          {/* Thumbnails */}
          <div className="flex lg:flex-col flex-row gap-4 items-center justify-center">
            <div
              className="w-[70px] h-[70px] md:w-[100px] md:h-[100px] bg-slate-300 border border-gray-400 rounded-md overflow-hidden cursor-pointer hover:scale-105 transition"
