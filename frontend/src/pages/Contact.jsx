...
function Contact() {
    ...
    <div className='w-[99vw] min-h-[100vh] flex items-center
      ...
      <div className='w-[100%] flex items-center justify-center
        ...
        <div className='lg:w-[50%] w-[100%] flex items-center
          justify-center '>
          <img   alt="" className='lg:w-[70%] w-[80%]
  ...
  text-[white] lg:text-[18px] mt-[10px] font-bold'>Careers at OneCart</p>

<p className='lg:w-[80%] w-[100%] 
  text-[white] md:text-[16px] text-[13px]'>Learn more about our teams and job 
openings</p>
